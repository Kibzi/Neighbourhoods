...
.container {
  ...
  <img src="img/Yardley.jpg" alt="" class="middle-right-image" width=450 height=350> 
  <div class="container">
  <div class="centered">Attributes:</div>
   
    <p>Population: 10,782<br>yearly crime rate: 3154<br>Transport:bus,Train,e-scooter<br>Shops:13<br>To rent:625-1400
    <br>to buy:115,506-184,915<br>1-6 in the pollution ration(good)<br>
</p>
