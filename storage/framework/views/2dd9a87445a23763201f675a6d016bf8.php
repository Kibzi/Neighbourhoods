...
.container {
  ...
  <img src="img/About.jpg" alt="" class="middle-right-image" width=450 height=350> 
  <div class="container">
  <div class="centered">About us</div>
    <p >i am a student who has created this webpage for students to find the right neighbourhood in which suits there style when looking for accomadations</p>
    <p> What am i trying to achieve? </p>
    <p> The goal of this webpage is to allow students to have the right information when looking for neighbourhoods hoping that this website which is created has all the information that they need.  </p>
  </body>
...
<?php /**PATH C:\xampp\htdocs\Neighbourhoods-For-You\resources\views/About.blade.php ENDPATH**/ ?>